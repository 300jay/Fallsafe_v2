...
.method public indexOf(BJJ)J
    ...
    invoke-interface {v2, v5, v9, v10}, Lokio/Source;->read(Lokio/Buffer;J)J
    ...
    .end local p2    # "result":J
    goto :goto_0

    .line 358
    .restart local v0    # "lastBufferSize":J
    .restart local p2    # "result":J
    :cond_2
    :goto_1
    return-wide v7
    ...
    const-string v2, "fromIndex=%s toIndex=%s"
...
.method public readUtf8LineStrict(J)Ljava/lang/String;
    ...
    invoke-virtual {v3, v1, v2}, Lokio/Buffer;->readUtf8Line(J)Ljava/lang/String;
    ...
    invoke-virtual {v3, v8, v9}, Lokio/Buffer;->getByte(J)B
    ...
    iget-object v10, p0, Lokio/RealBufferedSource;->buffer:Lokio/Buffer;
    ...
    invoke-direct {v3, v8}, Ljava/io/EOFException;-><init>(Ljava/lang/String;)V
    ...
    .end local v9    # "data":Lokio/Buffer;
    :cond_3
